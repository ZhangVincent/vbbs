...
import (
	...
	"vbbs/controllers/api"

	"vbbs/controllers/admin"
	"vbbs/middleware"
)
...
func Router() {
	...
	app.Any("/", func(i iris.Context) {
		_, _ = i.HTML("<div style=\"height: 200px; display: flex; align-items: center; justify-content: center;\"> <h1 style=\"width: 10em;\" >Welcome To V-BBS</h1> <a href=\"http://localhost:3000/\">click here</a> </div>")
	})
